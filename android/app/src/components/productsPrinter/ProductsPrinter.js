    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.row}>
          {Pdata.map((veg) => (
            <TouchableOpacity onPress={() => handleProduct(veg)} key={veg.id} style={styles.productContainer}>
              <Image
                source={{
                  uri: `${veg.image}`,
                }}
              ...
              <View style={styles.productInfo}>
                ...
                <Text style={styles.productPrice}>Price: ${veg.price}/{veg.unit}</Text>
              </View>
              <View style={styles.productTotal}>
                <Text style={styles.productTotalText}>{/* Total: ${calculateItemPrice(veg)} */}</Text>
              </View>
            </TouchableOpacity>
          ))}
        </View>
